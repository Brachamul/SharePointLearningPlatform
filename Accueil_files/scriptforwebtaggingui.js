...
Microsoft.SharePoint.Taxonomy.ScriptForWebTaggingUI.taggingLoad = function Microsoft_SharePoint_Taxonomy_ScriptForWebTaggingUI$taggingLoad() {ULSX8o:;
    ...
    if (document.body) {
        Microsoft.SharePoint.Taxonomy.ScriptForWebTaggingUI.attachRteEvent('keypress', Microsoft.SharePoint.Taxonomy.ScriptForWebTaggingUI.$2N);
        Microsoft.SharePoint.Taxonomy.ScriptForWebTaggingUI.attachRteEvent('keydown', Microsoft.SharePoint.Taxonomy.ScriptForWebTaggingUI.$2M);
    }
}
        ...
        if ($v_1) {
            if (Sys.UI.DomElement.containsCssClass($v_1, 'ms-taxonomy-writeableregion')) {
                ...
                switch (evt.keyCode) {
                    case 38:
                    case 40:
                        if (control.$1v_2(evt.keyCode === 38)) {
                            evt.stopPropagation();
                            evt.preventDefault();
                            $v_0 = true;
                        }
...
Microsoft.SharePoint.Taxonomy.ControlObject = function Microsoft_SharePoint_Taxonomy_ControlObject(container) {ULSX8o:;
    ...
    if (!this.$1_2) {
        ...
        if (!this.getInGridMode()) {
            ...
            $v_6.tabIndex = 0;
            $addHandler($v_6, 'click', this.$$d_$2D_2);
            $addHandler($v_6, 'keypress', this.$$d_$2H_2);
            Sys.UI.DomElement.addCssClass($v_6, 'ms-taxonomy-browser-button');
            $v_2.appendChild($v_6);
        }
        var $v_3 = document.createElement('DIV');
        this.$R_2 = $v_2.appendChild($v_3);
        ...
        if (!this.getInGridMode()) {
            this.setDisplayPickerButton(this.$n_2());
        }
        $addHandler(container, 'resize', this.$$d_$2I_2);
        ...
        this.$1_2 = this.$R_2.appendChild($v_4);
    ...
    this.$8_2.add_panelResizeBegin(this.$$d_$2Y_2);
    this.$8_2.add_panelResizeEnd(this.$$d_$2Z_2);
    this.$8_2.add_selectionMade(this.$$d_$2a_2);
    Sys.Net.WebRequestManager.add_invokingRequest(this.$$d_$2L_2);
}
Microsoft.SharePoint.Taxonomy.ControlObject.launchDialog = function Microsoft_SharePoint_Taxonomy_ControlObject$launchDialog(webTaggingId) {ULSX8o:;
    ...
    if ($v_1.isEnabled()) {
        ...
        $v_1.callFunctionAfterValidation($v_1.$$d_$2T_2);
    }
}
Microsoft.SharePoint.Taxonomy.ControlObject.$10 = function Microsoft_SharePoint_Taxonomy_ControlObject$$10($p0) {
    $p0 = $p0.replace(Microsoft.SharePoint.Taxonomy.ControlObject.$1T, '<').replace(Microsoft.SharePoint.Taxonomy.ControlObject.$1P, '>').replace(Microsoft.SharePoint.Taxonomy.ControlObject.$1Z, '\"').replace(Microsoft.SharePoint.Taxonomy.ControlObject.$1V, ' ').replace(Microsoft.SharePoint.Taxonomy.ControlObject.$1l, '\'').replace(Microsoft.SharePoint.Taxonomy.ControlObject.$16, '&');
    return $p0;
}
...
Microsoft.SharePoint.Taxonomy.ControlObject.$1y = function Microsoft_SharePoint_Taxonomy_ControlObject$$1y($p0) {
...
Microsoft.SharePoint.Taxonomy.ControlObject.encodeForControl = function Microsoft_SharePoint_Taxonomy_ControlObject$encodeForControl(text) {ULSX8o:;
    return text.replace(Microsoft.SharePoint.Taxonomy.ControlObject.$z, '%P').replace(Microsoft.SharePoint.Taxonomy.ControlObject.$1U, '%C').replace(Microsoft.SharePoint.Taxonomy.ControlObject.$19, '%B');
}
Microsoft.SharePoint.Taxonomy.ControlObject.decodeFromControl = function Microsoft_SharePoint_Taxonomy_ControlObject$decodeFromControl(text) {ULSX8o:;
    return text.replace(Microsoft.SharePoint.Taxonomy.ControlObject.$1A, '|').replace(Microsoft.SharePoint.Taxonomy.ControlObject.$1e, ';').replace(Microsoft.SharePoint.Taxonomy.ControlObject.$1Y, '%');
}
...
Microsoft.SharePoint.Taxonomy.ControlObject.prototype = {
    ...
    $2Z_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$2Z_2($p0, $p1) {
        window.setTimeout(this.$$d_$2U_2, 25);
    },
    ...
    $17_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$17_2($p0) {
        this.$1h_2(true);
    ...
    $1v_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$1v_2($p0) {
    ...
    $1c_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$1c_2($p0) {
        if ($p0.startsWith(this.$8_2.getCurrentStartsWith())) {
            ...
            if ($v_0) {
                ...
                var $v_2 = this.$1q_2($p0);
                var $v_3;
                for (var $v_4 = 0; $v_4 < $v_1; $v_4++) {
                    $v_3 = $v_0.get_labels()[$v_4];
                    if (this.$1q_2($v_3).startsWith($v_2)) {
                        this.$17_2($v_0.get_suggestValue());
                        this.$I_2(false);
                        return true;
                    }
                }
    ...
    $1q_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$1q_2($p0) {
    ...
    addTerm: function Microsoft_SharePoint_Taxonomy_ControlObject$addTerm(id, text) {ULSX8o:;
        var $v_0 = Microsoft.SharePoint.Taxonomy.Term.getTerms(this.$D_2());
        if ($v_0) {
    ...
    replaceCurrentTerm: function Microsoft_SharePoint_Taxonomy_ControlObject$replaceCurrentTerm(term) {ULSX8o:;
        var $v_0 = this.$26_2();
        var $v_1 = this.$28_2($v_0);
        var $v_2 = Microsoft.SharePoint.Taxonomy.Term.getTerms(this.$D_2());
    ...
    callFunctionAfterValidation: function Microsoft_SharePoint_Taxonomy_ControlObject$callFunctionAfterValidation(method) {ULSX8o:;
        if (method) {
            ...
            if ($v_0 || this.get_isFocused()) {
                ...
                window.setTimeout(this.$$d_$2S_2, 50);
            }
            else {
                method();
            }
    ...
    $U_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$U_2($p0) {
        var $v_0 = $p0;
        if (this.$O_2() && !$p0.indexOf('\"') && $p0.lastIndexOf('\"') === ($p0.length - 1)) {
    ...
    $1x_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$1x_2($p0) {
    ...
    validateAll: function Microsoft_SharePoint_Taxonomy_ControlObject$validateAll(restoreCursor) {ULSX8o:;
        ...
        var $v_3 = this.$1r_2($v_0, false, true, true);
        if ($v_1) {
            this.setTextAndCursor($v_3, restoreCursor);
        }
        else {
            this.$2e_2(this.getRawText());
        }
    },
    ...
    $1s_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$1s_2($p0) {
        if (this.$25_2() || this.$0_2.Validating || this.$0_2.UpdatingCursor) {
            return;
        }
        ...
        $v_0 = this.$1r_2($v_0, true, false, true);
        var $v_3 = Microsoft.SharePoint.Taxonomy.ControlObject.$10($v_0);
        var $v_4 = $v_3.replace('@@MARKER@@', '');
        $v_2 = $v_2.replace(Microsoft.SharePoint.Taxonomy.ControlObject.$l, '');
        $v_4 = $v_4.replace(Microsoft.SharePoint.Taxonomy.ControlObject.$l, '');
        if ($p0 && ($v_2 !== $v_4 || this.$a_2)) {
        ...
        if ($v_5.length >= 1) {
            if (this.$8_2.get_isShowing()) {
                ...
                this.$0_2.suggestionsStart = $v_5;
                var $v_7 = window.setTimeout(this.$$d_$2X_2, 0);
    ...
    $2X_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$2X_2() {ULSX8o:;
    ...
    $1k_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$1k_2($p0) {
        ...
        if ($v_0) {
            ...
            $v_1['start'] = $p0;
            $v_1['lcid'] = this.$d_2();
            $v_1['sspList'] = this.$e_2();
            $v_1['termSetList'] = this.getTermSetId();
            $v_1['anchorId'] = this.$b_2();
            $v_1['isSpanTermStores'] = this.$h_2();
            $v_1['isSpanTermSets'] = this.$V_2();
            $v_1['isIncludeUnavailable'] = this.$v_2();
            $v_1['isIncludeDeprecated'] = this.$t_2();
            $v_1['isAddTerms'] = this.$f_2();
            $v_1['isIncludePathData'] = this.$u_2();
            $v_1['excludeKeyword'] = this.$22_2();
            $v_1['excludedTermset'] = '00000000-0000-0000-0000-000000000000';
            Sys.Net.WebServiceProxy.invoke(this.getWebServicePath(), 'GetSuggestions', false, $v_1, this.$$d_$2Q_2, this.$$d_$2J_2, $p0, Sys.Net.WebRequestManager.get_defaultTimeout(), false, null);
        }
    },
    ...
    $2e_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$2e_2($p0) {
        if ($p0) {
            ...
            $v_0['terms'] = $p0;
            $v_0['lcid'] = this.$d_2();
            $v_0['SSPList'] = this.$e_2();
            $v_0['termSetList'] = this.getTermSetId();
            $v_0['anchorId'] = this.$b_2();
            $v_0['isSpanTermStores'] = this.$h_2();
            $v_0['isSpanTermSets'] = this.$V_2();
            $v_0['isIncludeUnavailable'] = this.$v_2();
            $v_0['isIncludeDeprecated'] = this.$t_2();
            $v_0['isAddTerms'] = this.$f_2();
            $v_0['isIncludeTermSetName'] = this.$1S_2();
            $v_0['isIncludePathData'] = this.$u_2();
            $v_0['isUseCommaAsDelimiter'] = this.$O_2();
            Sys.Net.WebServiceProxy.invoke(this.getWebServicePath(), 'GetMatches', false, $v_0, this.$$d_$1X_2, this.$$d_$2K_2, this, Sys.Net.WebRequestManager.get_defaultTimeout(), false, null);
            ...
            if ($v_0) {
                if (!this.$1x_2($v_0)) {
                    ...
                    if ($v_1) {
                        ...
                        $v_2['anchorId'] = this.$b_2();
                        $v_2['isSpanTermStores'] = this.$h_2();
                        $v_2['lcid'] = this.$d_2();
                        Sys.Net.WebServiceProxy.invoke(this.getWebServicePath(), 'ValidateTerms', false, $v_2, this.$$d_$2R_2, this.$$d_$2K_2, this, Sys.Net.WebRequestManager.get_defaultTimeout(), false, null);
                    }
                    else {
                        this.setRawText('');
                        this.retrieveTerms();
    ...
    $2Q_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$2Q_2($p0, $p1, $p2) {
        var $v_0 = this.$c_2(this.$S_2());
        if ($v_0) {
            var $v_1 = Microsoft.SharePoint.Taxonomy.Term.getTerms(this.$D_2());
            var $v_2 = {};
    ...
    $2R_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$2R_2($p0, $p1, $p2) {
        var $v_0 = $p0;
        this.setRawText(Microsoft.SharePoint.Taxonomy.ControlObject.$1y($v_0));
        this.retrieveTerms();
    },
    ...
    $p_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$p_2($p0, $p1) {
        $p0 = $p0.replace(Microsoft.SharePoint.Taxonomy.ControlObject.$1H, ';');
        if ($p1 && this.$O_2()) {
            ...
            if ($v_5 !== '' && $v_5 !== '@@MARKER@@') {
                if ($p1 && this.$O_2() && $v_5.indexOf(',') >= 0) {
                    ...
                    for (var $v_G = 0; $v_G < $v_5.length; $v_G++) {
                        var $v_H = $v_5.charAt($v_G);
                        if ($v_H === ',') {
                            if (!$v_6 && !$v_7 || ($v_A > $v_B && !($v_G - $v_B - $v_C))) {
                                var $v_I = $v_5.substring($v_B, $v_G);
                                if ($v_I.trim() !== '') {
                                    if ($v_D) {
                                        $v_D = false;
                                    }
                            ...
                            if ($v_H === '\"') {
                                ...
                                if ($v_8 >= $v_B) {
                                    if (!$v_7) {
                                        var $v_J = $v_5.substring($v_8, $v_G + 1);
                                        if ($v_J.match(Microsoft.SharePoint.Taxonomy.ControlObject.$1o)) {
                                            $v_7 = true;
                                            $v_C += $v_G - $v_8 + 1;
                                        }
                                        else {
                                        ...
                                        var $v_K = $v_5.substring($v_9, $v_G + 1);
                                        if ($v_K.match(Microsoft.SharePoint.Taxonomy.ControlObject.$1m)) {
                                            $v_A = $v_G;
                                            $v_7 = false;
                                            $v_C += $v_G - $v_9 + 1;
                                        }
                            ...
                            else if ($v_H === '@' && $v_5.substring($v_G, $v_G + 10) === '@@MARKER@@') {
                                $v_C += 10;
                                $v_G += 9;
                            }
                            if ($v_H !== ' ') {
                    ...
                    var $v_F = $v_5.substring($v_B, $v_5.length);
                    if ($v_F.trim() !== '') {
                        if (!$v_D) {
                            $v_3++;
                        }
                ...
                else if (this.$O_2() && $v_0[$v_4].endsWith(',@@MARKER@@</span>')) {
    ...
    $1r_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$1r_2($p0, $p1, $p2, $p3) {
        var $v_0 = this.$p_2($p0, $p3);
        var $v_1 = false;
        var $v_2 = '';
        var $v_3 = Microsoft.SharePoint.Taxonomy.Term.getTerms(this.$D_2());
        if ($v_3 && $v_3.length === $v_0.length) {
            for (var $v_4 = 0; $v_4 < $v_3.length; $v_4++) {
                ...
                if ($p2 && this.$U_2($v_6)) {
                    $v_2 += this.$E_2('invalid-text', Microsoft.SharePoint.Taxonomy.ScriptResources.webTaggingUI_Term_Contains_Illegal_Chars) + Microsoft.SharePoint.Taxonomy.ControlObject.$A($v_6) + this.$K_2();
                }
            ...
            if ($v_3 && $v_3.length > $v_0.length) {
                ...
                for (var $v_M = 0; $v_M < $v_0.length; $v_M++) {
                    ...
                    if ($v_M <= $v_J && $v_M > $v_J - $v_L) {
                        ...
                        if ($p2 && this.$U_2($v_O)) {
                            $v_2 += this.$E_2('invalid-text', Microsoft.SharePoint.Taxonomy.ScriptResources.webTaggingUI_Term_Contains_Illegal_Chars) + Microsoft.SharePoint.Taxonomy.ControlObject.$A($v_O) + this.$K_2();
                        }
                        else {
        ...
        if (this.getIsMulti() && $v_1) {
            $v_2 += Microsoft.SharePoint.Taxonomy.ControlObject.$1D;
        }
        return $v_2;
    },
    ...
    $J_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$J_2($p0, $p1, $p2) {
        if ($p0.$7_0 === '00000000-0000-0000-0000-000000000000') {
            ...
            var $v_1 = $v_0.exec($p2);
            if ($v_1) {
                return this.$E_2('invalid-text', Microsoft.SharePoint.Taxonomy.ScriptResources.webTaggingUI_Tooltip_invalid) + Microsoft.SharePoint.Taxonomy.ControlObject.$A($p1) + this.$K_2();
            }
            else {
            ...
            return this.$E_2('valid-text', '') + Microsoft.SharePoint.Taxonomy.ControlObject.$A($p1) + this.$K_2();
        }
    },
    
    getRawText: function Microsoft_SharePoint_Taxonomy_ControlObject$getRawText() {ULSX8o:;
        return Microsoft.SharePoint.Taxonomy.ControlObject.decodeFromControl(this.$D_2());
    },
    ...
    $28_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$28_2($p0) {
        Microsoft.SharePoint.Taxonomy.ScriptForWebTaggingUI.assertNotNull('text', $p0);
        var $v_0 = this.$p_2($p0, false);
        return this.$q_2($v_0);
    },
    
    $q_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$q_2($p0) {
        var $v_0 = 0;
    ...
    $c_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$c_2($p0) {
        if ($p0) {
            var $v_0 = this.$p_2($p0, false);
            var $v_1 = this.$q_2($v_0);
            if ($v_0.length > $v_1) {
                var $v_2 = $v_0[$v_1];
    ...
    $S_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$S_2() {ULSX8o:;
        var $v_0 = this.$o_2(this.$1_2);
        var $v_1 = new RegExp(Microsoft.SharePoint.Taxonomy.ControlObject.$j, 'g');
        $v_0 = $v_0.replace($v_1, ' ');
        ...
        for (var $v_1 = 0; $v_1 < $p0.childNodes.length; $v_1++) {
            ...
            if (Microsoft.SharePoint.Taxonomy.ControlObject.$1n.test($v_2.nodeName)) {
                ...
                if (Sys.UI.DomElement.containsCssClass($v_2, 'valid-text')) {
                    $v_0 += this.$E_2('valid-text', '');
                    $v_3 = true;
                }
                else if (Sys.UI.DomElement.containsCssClass($v_2, 'invalid-text')) {
                    $v_0 += this.$E_2('invalid-text', Microsoft.SharePoint.Taxonomy.ScriptResources.webTaggingUI_Tooltip_invalid);
                    $v_3 = true;
                }
                else {
            ...
            else if (Microsoft.SharePoint.Taxonomy.ControlObject.$1p.test($v_2.nodeName)) {
    ...
    $1B_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$1B_2() {ULSX8o:;
        var $v_0 = null;
        if (RTE.Cursor.get_range().isValid()) {
    ...
    $2T_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$2T_2() {ULSX8o:;
        Microsoft.SharePoint.Taxonomy.ControlObject.launch(this.$e_2(), this.getTermSetId(), this.$b_2(), this.$1J_2(), this.$D_2(), this.getIsMulti(), this.getAllowFillIn(), this.$d_2(), this.getWebServicePath(), this.$23_2(), this.$f_2(), this.$s_2(), this.$t_2(), this.$u_2(), this.$1S_2(), this.$v_2(), this.$V_2(), this.$h_2(), this.$O_2(), this.$$d_onDialogClose);
    },
    ...
    $n_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$n_2() {ULSX8o:;
        return this.$0_2.DisplayPickerButton;
    },
    
    $h_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$h_2() {ULSX8o:;
    ...
    $f_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$f_2() {ULSX8o:;
    ...
    getWebServicePath: function Microsoft_SharePoint_Taxonomy_ControlObject$getWebServicePath() {ULSX8o:;
        if (SP.ScriptUtility.isNullOrEmptyString(this.$M_2)) {
            this.$M_2 = this.$0_2.WebServiceUrl;
            this.$M_2 = decodeURI(this.$M_2);
            this.$M_2 = encodeURI(this.$M_2);
        }
        return this.$M_2;
    },
    ...
    $24_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$24_2($p0) {
        var $v_0 = '';
        this.$1j_2(false);
        if ($p0) {
            var $v_1 = false;
            ...
            for (var $v_3 = 0; $v_3 < $v_2.length; $v_3++) {
                if ($v_3 > 0) {
                    $v_0 += ';' + Microsoft.SharePoint.Taxonomy.ControlObject.$j;
                }
                if ($v_2[$v_3].get_isValid() && (this.getIsMulti() || !$v_3)) {
                    $v_0 += this.$E_2('valid-text', '') + Microsoft.SharePoint.Taxonomy.ControlObject.$A($v_2[$v_3].$5_0) + this.$K_2();
                    $v_1 = true;
                }
                else {
                    if (!this.getIsMulti() && $v_3 > 0) {
                        $v_0 += this.$E_2('invalid-text', Microsoft.SharePoint.Taxonomy.ScriptResources.webTaggingUI_Tooltip_multi_in_single);
                    }
                    else {
                        $v_0 += this.$E_2('invalid-text', Microsoft.SharePoint.Taxonomy.ScriptResources.webTaggingUI_Tooltip_invalid);
                    }
                    $v_0 += Microsoft.SharePoint.Taxonomy.ControlObject.$A($v_2[$v_3].$5_0) + this.$K_2();
    ...
    $E_2: function Microsoft_SharePoint_Taxonomy_ControlObject$$E_2($p0, $p1) {
        if (this.$s_2()) {
            return '';
        }
        else {
    ...
    if (arguments.length === 1) {
        if (data) {
            ...
            if ($v_0.length === 2) {
                ...
                this.$5_0 = Microsoft.SharePoint.Taxonomy.ControlObject.decodeFromControl($v_0[0]);
                this.$Q_0 = data.substring(this.$5_0.length + 1, data.length);
            }
            else {
                this.$5_0 = Microsoft.SharePoint.Taxonomy.ControlObject.decodeFromControl($v_0[0]);
...
Microsoft.SharePoint.Taxonomy.Term.prototype = {
    ...
    toString: function Microsoft_SharePoint_Taxonomy_Term$toString() {ULSX8o:;
        ...
        if (this.$Q_0 && this.$7_0 !== '00000000-0000-0000-0000-000000000000') {
            $v_0 += this.$Q_0;
        }
        else {
            $v_0 += this.$7_0;
...
Microsoft.SharePoint.Taxonomy.PanelResizer.prototype = {
    ...
    initialize: function Microsoft_SharePoint_Taxonomy_PanelResizer$initialize() {ULSX8o:;
        ...
        this.$i_2 = this.$$d_$w_2;
        this.$18_2(this.get_element(), 'mousedown', this.$i_2);
    },
    
    dispose: function Microsoft_SharePoint_Taxonomy_PanelResizer$dispose() {ULSX8o:;
        this.$1C_2(this.get_element(), 'mousedown', this.$i_2);
    ...
    $w_2: function Microsoft_SharePoint_Taxonomy_PanelResizer$$w_2($p0) {
        if (this.get_element().offsetWidth - $p0.offsetX < 15 && this.get_element().offsetHeight - $p0.offsetY < 15) {
            this.$1E_2();
            this.$B_2 = this.$$d_$x_2;
            this.$18_2(document.documentElement, 'mouseup', this.$B_2);
            $p0.preventDefault();
            $p0.stopPropagation();
        }
    },
    ...
    $x_2: function Microsoft_SharePoint_Taxonomy_PanelResizer$$x_2($p0) {
        this.$1C_2(document.documentElement, 'mouseup', this.$B_2);
    ...
    $18_2: function Microsoft_SharePoint_Taxonomy_PanelResizer$$18_2($p0, $p1, $p2) {
        if ($p2) {
            $addHandler($p0, $p1, $p2);
        }
    },
    
    $1C_2: function Microsoft_SharePoint_Taxonomy_PanelResizer$$1C_2($p0, $p1, $p2) {
        if ($p2) {
    ...
    $1F_2: function Microsoft_SharePoint_Taxonomy_PanelResizer$$1F_2() {ULSX8o:;
...
Microsoft.SharePoint.Taxonomy.SuggestionContainer = function Microsoft_SharePoint_Taxonomy_SuggestionContainer(container) {ULSX8o:;
    ...
    if (!Sys.UI.DomElement.containsCssClass(this.$2_2, 'ms-taxonomy-suggestion-container')) {
        ...
        Microsoft.SharePoint.Taxonomy.SuggestionContainer.$k(this.$2_2);
        var $v_0 = document.createElement('DIV');
        Sys.UI.DomElement.addCssClass($v_0, 'ms-taxonomy-suggestion-holder');
        this.$3_2 = container.appendChild($v_0);
        Microsoft.SharePoint.Taxonomy.SuggestionContainer.$k(this.$3_2);
        ...
        Microsoft.SharePoint.Taxonomy.SuggestionContainer.$k($v_1);
        Sys.UI.DomElement.addCssClass($v_1, 'ms-taxonomy-panel-resizer');
        this.$11_2 = container.appendChild($v_1);
        $addHandler($v_1, 'mousedown', this.$$d_$w_2);
        this.set_$1W_2(false);
    }
    else {
        this.$3_2 = this.$2_2.firstChild;
        this.$11_2 = this.$2_2.lastChild;
    }
    this.$L_2 = new Sys.UI.Point(0, 0);
    this.$H_2 = new Sys.UI.Point(0, 0);
    this.$N_2 = (document.documentElement.getAttribute('dir') === 'rtl');
}
Microsoft.SharePoint.Taxonomy.SuggestionContainer.$k = function Microsoft_SharePoint_Taxonomy_SuggestionContainer$$k($p0) {
...
Microsoft.SharePoint.Taxonomy.SuggestionContainer.prototype = {
    ...
    $w_2: function Microsoft_SharePoint_Taxonomy_SuggestionContainer$$w_2($p0) {
        this.$1E_2();
        if (this.$B_2) {
            $removeHandler(document.documentElement, 'mouseup', this.$B_2);
        }
        if (this.$P_2) {
            $removeHandler(document.documentElement, 'mousemove', this.$P_2);
        }
        this.$L_2.x = $p0.clientX;
        this.$L_2.y = $p0.clientY;
        this.$B_2 = this.$$d_$x_2;
        $addHandler(document.documentElement, 'mouseup', this.$B_2);
        this.$P_2 = this.$$d_$2O_2;
        $addHandler(document.documentElement, 'mousemove', this.$P_2);
        $p0.preventDefault();
    },
    
    $2O_2: function Microsoft_SharePoint_Taxonomy_SuggestionContainer$$2O_2($p0) {
        $p0.preventDefault();
        this.$H_2.x = $p0.clientX;
        this.$H_2.y = $p0.clientY;
        var $v_0 = this.$H_2.x - this.$L_2.x;
        if (this.$N_2) {
            $v_0 = -$v_0;
        }
        var $v_1 = this.$H_2.y - this.$L_2.y;
        var $v_2 = this.width() + $v_0;
        var $v_3 = this.height() + $v_1;
        this.$L_2.x = this.$H_2.x;
        this.$L_2.y = this.$H_2.y;
        this.setWidth($v_2);
        this.setHeight($v_3);
    },
    ...
    $2W_2: function Microsoft_SharePoint_Taxonomy_SuggestionContainer$$2W_2($p0, $p1) {
        var $v_0 = $p1.$9_2.offsetTop + $p1.$C_2.clientHeight + $p0.$4_2.offsetTop;
    ...
    $29_2: function Microsoft_SharePoint_Taxonomy_SuggestionContainer$$29_2($p0, $p1, $p2, $p3) {
    ...
    $1F_2: function Microsoft_SharePoint_Taxonomy_SuggestionContainer$$1F_2() {ULSX8o:;
        var $v_0 = this.get_events().getHandler('panelResizeEnd');
        if ($v_0) {
            $v_0(this, null);
        }
    ...
    $m_2: function Microsoft_SharePoint_Taxonomy_SuggestionContainer$$m_2($p0) {
...
Microsoft.SharePoint.Taxonomy.SuggestionGroup = function Microsoft_SharePoint_Taxonomy_SuggestionGroup(container, columns) {ULSX8o:;
    ...
    if (arguments.length === 1) {
        this.$9_2 = container;
        this.$C_2 = $get(container.id + 'Title');
        ...
        if (!this.$C_2) {
            ...
            this.$C_2.id = this.$9_2.id + 'Title';
            this.$C_2 = this.$9_2.appendChild(this.$C_2);
            Sys.UI.DomElement.addCssClass(this.$C_2, 'ms-taxonomy-suggestion-group-title');
        }
...
Microsoft.SharePoint.Taxonomy.SuggestionGroup.prototype = {
    ...
    $r_2: function Microsoft_SharePoint_Taxonomy_SuggestionGroup$$r_2() {ULSX8o:;
        var $v_0 = new Microsoft.SharePoint.Taxonomy.Suggestion(this.$6_2.firstChild);
        $v_0.highlight(true);
        return $v_0;
    },
    ...
    $1w_2: function Microsoft_SharePoint_Taxonomy_SuggestionGroup$$1w_2() {ULSX8o:;
    ...
    $2c_2: function Microsoft_SharePoint_Taxonomy_SuggestionGroup$$2c_2($p0) {
        var $v_0 = false;
        var $v_1 = null;
    ...
    $m_2: function Microsoft_SharePoint_Taxonomy_SuggestionGroup$$m_2($p0) {
        var $v_0 = this.get_events().getHandler('selectionMade');
        if ($v_0) {
            var $v_1 = new Microsoft.SharePoint.Taxonomy.SelectionMadeEventArgs($p0);
            $v_0(this, $v_1);
...
Microsoft.SharePoint.Taxonomy.Suggestion = function Microsoft_SharePoint_Taxonomy_Suggestion(container, originalStart, starts, completions, paths, fullText, isSynonym, isKeyword, id, tooltip) {ULSX8o:;
    ...
    this.$g_2 = (document.documentElement.dir === 'rtl');
    if (arguments.length === 1) {
        this.$4_2 = container;
        ...
        $addHandler(this.$4_2, 'mouseover', this.$$d_$2P_2);
...
Microsoft.SharePoint.Taxonomy.Suggestion.prototype = {
    ...
    $1u_2: function Microsoft_SharePoint_Taxonomy_Suggestion$$1u_2($p0, $p1, $p2) {
        $p0.append('<span');
        if (this.$g_2) {
            $p0.append(' dir=\"rtl\"');
        }
    ...
    $2P_2: function Microsoft_SharePoint_Taxonomy_Suggestion$$2P_2($p0) {
    ...
    $m_2: function Microsoft_SharePoint_Taxonomy_Suggestion$$m_2($p0) {
        var $v_0 = this.get_events().getHandler('selectionMade');
        if ($v_0) {
...
Microsoft.SharePoint.Taxonomy.ControlObject.$16 = new RegExp('&amp;', 'ig');
...
Microsoft.SharePoint.Taxonomy.ControlObject.$1A = new RegExp('%B', 'ig');
...
Microsoft.SharePoint.Taxonomy.ControlObject.$21 = new RegExp('^(\\s)*<span class=[^>]*>', 'i');
Microsoft.SharePoint.Taxonomy.ControlObject.$1t = new RegExp('&', 'ig');
Microsoft.SharePoint.Taxonomy.ControlObject.$2F = new RegExp('<', 'ig');
Microsoft.SharePoint.Taxonomy.ControlObject.$2B = new RegExp('>', 'ig');
Microsoft.SharePoint.Taxonomy.ControlObject.$2V = new RegExp('\"', 'ig');
Microsoft.SharePoint.Taxonomy.ControlObject.$2G = new RegExp(' ', 'ig');
Microsoft.SharePoint.Taxonomy.ControlObject.$19 = new RegExp('\\|', 'ig');
...
Microsoft.SharePoint.Taxonomy.ControlObject.$l = new RegExp('(,|;| )+$', 'i');
Microsoft.SharePoint.Taxonomy.ControlObject.$1n = new RegExp('span', 'i');
Microsoft.SharePoint.Taxonomy.ControlObject.$1p = new RegExp('#text', 'i');
Microsoft.SharePoint.Taxonomy.ControlObject.$1D = ';' + ' ';
Microsoft.SharePoint.Taxonomy.ControlObject.$j = String.fromCharCode(160);
Microsoft.SharePoint.Taxonomy.ControlObject.$X = String.fromCharCode(8203);
Microsoft.SharePoint.Taxonomy.ControlObject.$1H = String.fromCharCode(65307);
Microsoft.SharePoint.Taxonomy.ControlObject.$1G = String.fromCharCode(65292);
